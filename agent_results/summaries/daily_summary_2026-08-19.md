...
- MDLZ: WATCH score=0.51 reason=WATCH: Technical setup detected, but weighted risk/reward 1.49 is below minimum 2.00. Market regime BULL; sector STRONG; net R/R 1.17.
...
- SUI: WATCH score=0.5 reason=Gross R/R is valid, but Net R/R 1.48 failed minimum 2.00 after slippage/spread adjustment.
...
- VZ: SKIP score=0.49 reason=SKIP: Communication Services sector regime is weak (27/100); skip new entry. Market regime BULL; sector WEAK; net R/R 1.11.
- HSY: WATCH score=0.49 reason=WATCH: Technical setup detected, but weighted risk/reward 1.40 is below minimum 2.00. Market regime BULL; sector STRONG; net R/R 0.85.
