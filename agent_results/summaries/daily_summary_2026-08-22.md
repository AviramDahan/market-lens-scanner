...
WATCH_READY session split: regular=0, off_hours=39, unknown=0
...
- MOS: WATCH score=0.47 reason=WATCH: Technical setup detected, but weighted risk/reward 1.11 is below minimum 2.00. Market regime NEUTRAL; sector STRONG; net R/R 0.79.
- OKE: WATCH score=0.46 reason=WATCH: Position cannot be opened because market regime exposure cap leaves no executable size.
- DASH: WATCH score=0.46 reason=WATCH: Technical setup detected, but weighted risk/reward 1.40 is below minimum 2.00. Market regime NEUTRAL; sector STRONG; net R/R 1.04.
