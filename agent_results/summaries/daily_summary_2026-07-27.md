...
- PLD: WATCH score=0.39 reason=WATCH: Technical setup detected, but weighted risk/reward 1.18 is below minimum 2.00. Market regime BEAR; sector STRONG; net R/R 0.82.
- META: SKIP score=0.38 reason=SKIP: Communication Services sector regime is weak (12/100); skip new entry. Market regime BEAR; sector WEAK; net R/R 0.95.
- MS: SKIP score=0.37 reason=WATCH: Position cannot be opened because market regime exposure cap leaves no executable size.
