...
- KLAC: SKIP score=0.53 reason=SKIP: Semiconductors sector regime is weak (17/100); skip new entry. Market regime BULL; sector WEAK; net R/R 3.10.
- GS: WATCH score=0.53 reason=QUALIFIED_CAPITAL_BLOCKED: All active entry-quality gates passed, but Position cannot be opened because Financials sector exposure cap leaves no executable size.
...
- BRK-B: WATCH score=0.49 reason=WATCH: Technical setup detected, but weighted risk/reward 1.75 is below minimum 2.00. Market regime BULL; sector STRONG; net R/R 1.15.
