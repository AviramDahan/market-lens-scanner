...
- ETN: WATCH score=0.58 reason=WATCH: Technical setup detected, but weighted risk/reward 1.47 is below minimum 2.00. Market regime BULL; sector STRONG; net R/R 1.14.
- ETN: WATCH score=0.58 reason=WATCH: Technical setup detected, but weighted risk/reward 1.47 is below minimum 2.00. Market regime BULL; sector STRONG; net R/R 1.14.
- MA: WATCH score=0.55 reason=WATCH: Entry confirmation failed - Breakout/retest confirmation requires completed close above trigger, held retest, and no falling candle.
