...
- DUK: WATCH score=0.55 reason=WATCH: Target 1 net R/R 0.73 is below minimum 0.80; Target 2 cannot justify the entry alone.
- DUK: WATCH score=0.54 reason=WATCH: NEUTRAL market requires setup score (0.54 < 0.55).
- AMD: WATCH score=0.53 reason=WATCH: NEUTRAL market requires setup score (0.53 < 0.55).
- MA: WATCH score=0.53 reason=WATCH: Technical setup detected, but weighted risk/reward 1.76 is below minimum 2.00. Market regime NEUTRAL; sector STRONG; net R/R 1.28.
