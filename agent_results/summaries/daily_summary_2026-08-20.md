...
Unrealized PnL: 236.2
Portfolio value: 101589.46
Best ticker: ORCL
Worst ticker: ECL
...
- RELATIVE_STRENGTH_LEADER: 109
- TREND_PULLBACK_RECLAIM: 59
- VWAP_RECLAIM: 28

Top rejected candidates:
- MP: WATCH score=0.6 reason=WATCH: Entry confirmation failed - Breakout/retest confirmation requires completed close above trigger, held retest, and no falling candle.
...
- CBRE: WATCH score=0.49 reason=WATCH: Technical setup detected, but weighted risk/reward 1.46 is below minimum 2.00. Market regime NEUTRAL; sector STRONG; net R/R 0.95.
